...
const points = [
  {
    ...
    description: "Started with a core vision to build practical technical capabilities in college students by organizing hands-on coding bootcamps and local programming sessions.",
